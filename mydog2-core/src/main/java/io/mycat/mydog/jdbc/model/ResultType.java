package io.mycat.mydog.jdbc.model;
...
public class ResultType {
	...
	public String getGenerateClassName() {
		...
		generateClassName = generateClassName.replace("java.sql.Timestamp", "java.util.Date");
		generateClassName = generateClassName.replace("java.sql.Date", "java.util.Date");
